...
export const metadata: Metadata = {
  title: "Project | Leyen",
  metadataBase: new URL("https://leyen.me/projects"),
  description: "Explore projects built by Leyen",
  openGraph: {
    title: "Projects | Leyen",
    url: "https://leyen.me/projects",
    description: "Explore projects built by Leyen",
    images:
...
export default async function Project() {
  ...
  return (
    <main className="max-w-7xl mx-auto md:px-16 px-6">
      <PageHeading
        title="Projects"
        description="A collection of personal projects where ideas come to life."
      />
