...
export const resumeData: ResumeData = {
  ...
  projects: [
    ...
    },
    {
      name: "唐山鼎坤机械生产管理系统",
      description:
        "基于若依系开源后台框架进行二次开发的企业内部管理系统，主要承载机械生产相关业务流程和基础管理能力，在保留原有通用后台模块的基础上，结合实际业务对审批流、流程发起、任务处理和首页待办展示等功能进行了定制化开发。",
      responsibilities: [
        "基于现有若依后台框架进行业务二开，主要负责审批流程相关前端功能开发。",
        "参与流程发起、流程分类选择、表单提交、任务处理、流程详情查看等页面适配与联调。",
        "参与首页待办任务展示、流程流转交互及相关业务页面接入。",
        "配合后端完成业务流程在系统中的落地，并处理上线后的页面问题与交互优化。",
      ],
    },
  ],
  skills: [
